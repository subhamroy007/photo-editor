...
type ReplyLikesNavigationParams = CompositeScreenProps<
  NativeStackScreenProps<UtilityStackNavigatorParams, "ReplyLikes">,
...
export function ReplyLikes({
  navigation,
  route: {
    params: { replyId },
  },
}: ReplyLikesNavigationParams) {
  return (
    <SafeAreaView
